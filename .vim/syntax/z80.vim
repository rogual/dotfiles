...
" Label Definitions
syn match z80SubLabel "^\.\k\+" containedin=ALL
syn match z80Label "^\k\+" containedin=ALL

" Label References

syn match z80Label "[A-Z_.?][A-Z_.?0-9]*:\="
syn match z80SubLabel "\.[A-Z_.?][A-Z_.?0-9]*:\="
...
HiLink z80Label Function
HiLink z80SubLabel Label
